            ...
            <div class="card">
                <div class="card-body">
                    <div class="float-end">
                        ...
                        <a href="dosen-profil/edit" class="btn btn-light" aria-expanded="false"><i
                        ...
                        <div class="col-sm-auto d-flex justify-content-sm-start justify-content-center">
                            <div class="avatar-xl mb-4 profile-image-container">
                                @if (!empty($dosen->foto))
                                    ...
                                    <img src="{{ asset('storage/profile_image/' . $dosen->foto) }}"
                                ...
                                <form action="{{ route('foto.profile') }}" method="POST"
                                ...
                                <table class="table table-nowrap mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ optional($dosen)->google_scholar }}" class="btn btn-sm btn-primary">Buka</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
