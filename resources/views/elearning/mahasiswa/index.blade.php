                                ...
                                <div class="">
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#tambahdosen"
                                        class="btn btn-success btn-rounded waves-effect waves-light mb-2"><i
                                            class="mdi mdi-plus me-1"></i> Gabung Kelas</button>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('emahasiswa.store') }}" method="POST">
                                                                @csrf
                                                                <div class="mb-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex gap-1">
                                            ...
                                            <a href="{{ route('kelas.detail', ['kode_kelas' => $user->kode_kelas]) }}" class="btn btn-sm btn-outline-success waves-effect waves-light">Masuk Kelas</a>
