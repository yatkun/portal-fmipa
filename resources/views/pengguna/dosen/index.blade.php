                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <h4 class="card-title flex-grow-1">Daftar Dosen</h4>
                                ...
                                <div class="">
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#tambahdosen"
                                        class="btn btn-success btn-rounded waves-effect waves-light mb-2"><i
                                            class="mdi mdi-plus me-1"></i> Tambah Dosen</button>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="nama" class="col-form-label">Nama Dosen:</label>
                                                                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Masukkan nama dosen" value="{{ $user->nama }}">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="nidn" class="col-form-label">NIDN:</label>
                                                                    <input type="text" name="nidn" class="form-control" id="nidn" placeholder="Masukkan NIDN" value="{{ $user->nidn }}">
                                                                </div>
