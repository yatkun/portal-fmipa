...
<head>
    ...
    <style>
        ...
        .bg-grid {
            opacity: 0.2;
            background-image: linear-gradient(90deg, transparent 24%, rgba(0, 0, 0, 0.1) 25%, rgba(0, 0, 0, 0.1) 26%, transparent 27%, transparent 74%, rgba(0, 0, 0, 0.1) 75%, rgba(0, 0, 0, 0.1) 76%, transparent 77%),
                    ...
                    <div class="card overflow-hidden" style="margin-bottom: 0px">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2 mt-3">
                                ...
                                <form id="cekdata" method="post" action="{{ route('checkpengumuman') }}"
                                    ...
                                    <div class="mt-3 d-grid">
                                        <button class="btn btn-md btn-primary waves-effect waves-light" type="submit"
                                            id="submitBtn">Lihat Hasil</button>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>©
                            ...
                            </script> Portal FMIPA Unsulbar. Crafted with <i
